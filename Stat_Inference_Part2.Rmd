...
* While we havent added the data here performing a two-sided t-test on the method of delivery acutally fails to reject the null hypothesis. As we exploratory analysis suggested that there wasn't just a difference but that one had a greater effect than the other we chose a one-sided test.
